...
HISTSIZE=10000
SAVEHIST=10000
#HISTFILE=~/.cache/zsh/history # If you want to change location.
...
# theme repo: https://github.com/Powerlevel9k/powerlevel9k
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(command_execution_time vi_mode user vcs dir)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(root_indicator background_jobs status time dir_writable ssh)

# Load aliases and shortcuts if existent.
[ -f "$HOME/.config/shortcutrc" ] && source "$HOME/.config/shortcutrc"
[ -f "$HOME/.config/aliasrc" ] && source "$HOME/.config/aliasrc"

#This line should remain the last call of this file.
